...
namespace CodeFactoryDb
{
    ...
    /// </summary>
    internal class CodeSetManager
    {
       /// <summary>
       /// Constructor
       /// </summary>
        internal CodeSetManager()
        {
        }
        ...
        [SqlProcedure]
        internal  Int32 AddCodeSet(string Code, string ShortValue, string LongValue, 
                                                DateTime EffectiveFromDate, DateTime EffectiveToDate, string CategoryCode)
        {
            Int32 Result = 0;
            StringBuilder CodeSetQuery = new StringBuilder();
