...
namespace vkg.codefactory.Assembly
{
    internal static class ProcessDatSet
    {
        ...
        private static SqlMetaData SqlMetaDataFromColumn(DataColumn column, out bool coerceToString)
        {
            ...
            switch (Type.GetTypeCode(clrType))
            {
                ...
                case TypeCode.String: smd = new SqlMetaData(name, SqlDbType.NVarChar, column.MaxLength); break;
